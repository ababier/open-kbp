...
if __name__ == '__main__':
    ...
    primary_directory = '/Users/aaronbabier/open-kbp'  # directory where everything is stored

    # Define directory where given data is stored
    training_data_dir = '{}/train-pats'.format(primary_directory)
    validation_data_dir = '{}/valid-pats'.format(primary_directory)
    # path where any data generated by this code (e.g., predictions, models) are stored
    results_dir = '{}/open-kbp-results'.format(primary_directory)
